                        ...
                        <form method="post" action="Controlador?menu=Pedidos">
                            <div class="row">
                                <div class="col-md-4 d-flex">
                                    <input type="number" name="txtidcliente" class="form-control" placeholder="id cliente" value="${cliente.getId()}">
                                ...
                                <div class="col-md-8 d-flex">
                                  <input type="text" name="txtapellidocliente" class="form-control" placeholder="Apellido cliente" value="${cliente.getApellido()}">
                                </div>
                            </div>
                            <div class="row"></div>
